...
export const StylesStepsMobile = ({ handleNextStep }: Props) => {
  ...
  return (
    <C.Flex ml="5%" mr="5%" mt={'24px'} direction={'column'}>
      ...
      <C.Flex mt={'16px'} h='60px' w={'100%'} bg='whiteAlpha.800' justifyContent={'space-between'} alignItems={'center'} p='16px' borderRadius={'16px'}>
        <C.Text color={'blackAlpha.900'} fontSize={'14px'} fontWeight={'bold'}>
          A duração padrão do show pode<br /> variar de acordo com os estilos!
        </C.Text>
        <C.Tooltip
